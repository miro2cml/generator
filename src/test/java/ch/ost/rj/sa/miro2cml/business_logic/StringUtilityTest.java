...
class StringUtilityTest {
    ...
    void removeDoubleSpace_1() {
        ...
        final String resultOne = StringUtility.reduceMultipleSpacesToOne(inputOne);
    ...
    void removeSimpleHtmlTags_1() {
        final String inputOne = "String";
        final String expectedOne = "String";
        final String resultOne = StringUtility.removeSimpleHtmlTags(inputOne);
        assertEquals(expectedOne, resultOne);
    }
    @Test
    ...
    void extractHtmlLink_1() {
        final String inputOne = "String";
        final String expectedOne = "String";
        final String resultOne = StringUtility.extractHtmlLink(inputOne);
        assertEquals(expectedOne, resultOne);
    }
    @Test
    ...
    void removeHtmlBreaks_1() {
        final String inputOne = "String";
        final String expectedOne = "String";
        final String resultOne = StringUtility.removeHtmlBreaks(inputOne);
        assertEquals(expectedOne, resultOne);
    }
    @Test
    ...
    void replaceHtmlCodeWithString_1() {
        final String inputOne = "&gt;String&lt;";
        final String expectedOne = ">String<";
        final String resultOne = StringUtility.replaceSpecialCharCodesWithTheirSingleCharEquivalent(inputOne);
        assertEquals(expectedOne, resultOne);
    }
    ...
    void removeSonderzeichen_1() {
        ...
        final String expectedOne = "String";
        final String resultOne = StringUtility.removeSpecialCharacters(inputOne);
        assertEquals(expectedOne, resultOne);
    }
    ...
    void replaceSpaceWithLine() {
        ...
        final String resultOne = StringUtility.replaceSpaceWithUnderscore(inputOne);
        assertEquals(expectedOne, resultOne);
    }
    ...
    void convertForVariableName() {
        ...
        final String resultOne = StringUtility.convertForVariableName(inputOne);
        assertEquals(expectedOne, resultOne);
    }
    ...
    void validatorForStrings() {
        ...
        final String resultOne = StringUtility.validatorForStrings(inputOne);
        assertEquals(expectedOne, resultOne);
    }
    ...
    void removeAllHtmlTags(){
        ...
        final String resultOne = StringUtility.removeAllHtmlTags(inputOne);
        assertEquals(expectedOne, resultOne);
        ...
        final String resultTwo = StringUtility.removeAllHtmlTags(inputTwo);
    ...
    void removeLeadingNumbers(){
        ...
        final String resultOne = StringUtility.removeLeadingNumbers(inputOne);
        assertEquals(expectedOne, resultOne);

        final String inputTwo = "test123";
        final String expectedTwo = "test123";
        final String resultTwo = StringUtility.removeLeadingNumbers(inputTwo);
        assertEquals(expectedTwo, resultTwo);

        final String inputThree = "123test123";
        final String expectedThree = "test123";
        final String resultThree = StringUtility.removeLeadingNumbers(inputThree);
    ...
    void uniqueValue(){
        ...
        final String resultOne = StringUtility.uniquifyValue(list, "FirstValue");
        assertEquals(expectedOne, resultOne);
        assertEquals(list.get(1), resultOne);

        final String expectedTwo = "FirstValue11";
        final String resultTwo = StringUtility.uniquifyValue(list, "FirstValue");
        assertEquals("FirstValue11",list.get(2));
        assertEquals(expectedTwo, resultTwo);


        final String expectedThree = "SecondValue";
        final String resultThree = StringUtility.uniquifyValue(list, "SecondValue");
        assertEquals(expectedThree, resultThree);
